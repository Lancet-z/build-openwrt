...
sed -i "s/OpenWrt /林子安专版 build $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/"管理权"/"管理"/g' feeds/luci/modules/luci-base/po/zh-cn/base.po
